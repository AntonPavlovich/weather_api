...
export class AddLatAndLonColumnToWeatherDataTable1697663050842
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "weather_data" ADD "lat" numeric NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "weather_data" ADD "lon" numeric NOT NULL`,
    );
  }
